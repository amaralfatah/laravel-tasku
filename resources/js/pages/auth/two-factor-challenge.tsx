    ...
    const authConfigContent = useMemo<{
        ...
        if (showRecoveryInput) {
            return {
                ...
                description:
                    'Konfirmasi akses akun dengan salah satu kode pemulihan darurat Anda.',
                    ...
                    {({ errors, processing, clearErrors }) => (
                        <>
                            ...
                            <div className="text-center text-sm text-muted-foreground">
                                ...
                                <button
                                    type="button"
                                    className="cursor-pointer text-link underline decoration-link/40 underline-offset-4 transition-colors duration-300 ease-out hover:decoration-current!"
                                    onClick={() =>
