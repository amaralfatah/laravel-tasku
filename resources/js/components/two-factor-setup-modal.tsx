                            ...
                            {!manualSetupKey ? (
                                ...
                                <>
                                    ...
                                    <button
                                        ...
                                        className="border-l border-border px-3 hover:bg-accent"
                                    >
    ...
    const modalConfig = useMemo<{
        ...
        if (twoFactorEnabled) {
            return {
                ...
                description:
                    'Autentikasi dua faktor sudah aktif. Pindai kode QR atau masukkan kunci setup di aplikasi authenticator Anda.',
                buttonText: 'Tutup',
            };
        }
        ...
        return {
            ...
            description:
                'Pindai kode QR atau masukkan kunci setup di aplikasi authenticator untuk menyelesaikan pengaktifan',
            buttonText: 'Lanjutkan',
        };
